...
export const metadata: Metadata = {
  title: 'Shipping Policy — TrailNest',
  description: 'Everything you need to know about how TrailNest ships your order, delivery timeframes, and tracking.',
};
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 section-py">
        <div className="prose text-[#555] space-y-8">
          ...
          <section>
            ...
            <p>Once your order ships, you will receive an email containing your tracking number and a direct link to track your parcel in real time. You can also contact us at <a href="mailto:support@trailnest.co" className="text-tn-600 hover:underline">support@trailnest.co</a> with your order number and we will provide an update.</p>
          </section>

          <section>
            <h2 className="heading-sm text-[#111] mb-3">Delivery Areas</h2>
            <p>Shipping zones and carrier partners will be published here once finalised. For questions about delivery to your area, contact us at <a href="mailto:support@trailnest.co" className="text-tn-600 hover:underline">support@trailnest.co</a>.</p>
          </section>

          <section>
            <h2 className="heading-sm text-[#111] mb-3">Damaged or Lost Orders</h2>
            <p>If your order arrives damaged, please contact us at <a href="mailto:support@trailnest.co" className="text-tn-600 hover:underline">support@trailnest.co</a> within 48 hours of delivery with clear photos of the damage. We will arrange a replacement at no cost to you.</p>
          ...
          <section>
            ...
            <p>It is the customer&apos;s responsibility to ensure the shipping address provided at checkout is accurate and complete. TrailNest is not responsible for orders delivered to an incorrect address provided by the customer. If you notice an error in your shipping address after placing an order, please contact us immediately at <a href="mailto:support@trailnest.co" className="text-tn-600 hover:underline">support@trailnest.co</a> — we can amend the address before fulfilment if the order has not yet been dispatched.</p>
          </section>
        </div>
      </div>
    </div>
