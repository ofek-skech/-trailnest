    ...
    <div className="min-h-screen" style={{ background: '#FAF8F3' }}>
      ...
      <div className="text-white pt-[80px] pb-16 lg:pt-[88px] lg:pb-20" style={{ background: '#1E2020' }}>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="overline mb-3" style={{ fontFamily: 'Rubik, sans-serif', color: '#E8940A' }}>
            הסיפור שלנו
          </p>
      ...
      {/* Stats */}
      <div style={{ background: '#F4EEE4' }} className="border-b border-[#DDD5C8]">
      ...
      {/* Values */}
      <div style={{ background: '#F4EEE4' }} className="border-t border-[#DDD5C8]">
